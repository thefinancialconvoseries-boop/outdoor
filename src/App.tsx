...
export default function App() {
  return (
    <div className="min-h-screen bg-[#FFFFFF] text-[#0B1330] flex flex-col justify-between">
      <NavHeader />
      ...
      <footer className="w-full border-t border-[#D7E0F5] py-8 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#7178A0]">
          <div className="flex items-center gap-2">
            <span className="font-display font-semibold text-[#0B1330]">The Financial Blueprint</span>
            <span>·</span>
